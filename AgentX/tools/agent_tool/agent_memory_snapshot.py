...
Manages project-scoped memory snapshots for team sharing:
  - Snapshot dir: ``<cwd>/.agentx/agent-memory-snapshots/<agentType>/``
...
def get_snapshot_dir_for_agent(agent_type: str, *, cwd: str = "") -> str:
    """Return snapshot directory: ``<cwd>/.agentx/agent-memory-snapshots/<type>/``."""
    effective_cwd = cwd or os.getcwd()
    return os.path.join(effective_cwd, ".agentx", SNAPSHOT_BASE, agent_type) + os.sep
