...
from AgentX.constants.identity import get_app_display_name
from AgentX.data_types import ConfigAction, ToolParameterType, ToolResult, coerce_str_enum
from AgentX.pydantic_models import model_to_dict
from AgentX.tools.base import BaseTool, ToolParameter
from AgentX.tools.tool_names import CONFIG_TOOL_NAME
...
class ConfigTool(BaseTool):
    ...
    def get_description(self) -> str:
        return f"Read or update {get_app_display_name()} configuration settings."
