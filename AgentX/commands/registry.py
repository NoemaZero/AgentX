...
from AgentX.pydantic_models import FrozenModel, model_to_dict
...
class CompactCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        ...
        from AgentX.services.compact.compact import compact_messages
...
class DiffCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        from AgentX.utils.git import run_git_command
...
class VersionCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        ...
        from AgentX.constants.identity import get_app_package_name

        return f"{get_app_package_name()} {__version__}"
...
class PermissionsCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        ...
        new_mode = args.strip()
        if new_mode:
            from AgentX.data_types import PermissionMode, maybe_coerce_str_enum
...
class ResumeCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        ...
        from AgentX.utils.history import list_sessions, resume_session
...
class DoctorCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        from AgentX.utils.setup import check_environment
...
class BugCommand(Command):
    ...
    async def execute(self, args: str, **kwargs: Any) -> str:
        from AgentX.constants.identity import get_app_issues_url

        issues_url = get_app_issues_url()
        return (
