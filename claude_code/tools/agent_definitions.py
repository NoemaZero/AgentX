...
1. ~/.claude/agents/  — user agents
2. .claude/agents/    — project agents
...
from claude_code.data_types import AgentContextMode, AgentModel, maybe_coerce_str_enum
...
def get_all_agent_definitions(
    ...
    1. Project agents: .claude/agents/ (walk up to home)
